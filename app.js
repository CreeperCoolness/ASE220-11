...
app.post('/Sign_in.html',(req,res)=>{
	...
	let csvString1=fs.readFileSync('./usercredentials.csv', 'utf8')
	let jsArray1=csvString1.split(/[\r\n]+/)
	
	const { email, password } = req.body;
	
	let good = false;

for(let i = 0; i < jsArray1.length - 1; i++){
	let user_account = jsArray1[i].split(',')
